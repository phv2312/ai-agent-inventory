...
export const AttachmentIcon = ({ className = "w-5 h-5", onClick }: IconProps) => (
    <svg
        className={className}
        fill="none"
        stroke="currentColor"
...
// Close/X Icon
export const CloseIcon = ({ className = "w-4 h-4", onClick }: IconProps) => (
    <svg
        className={className}
        fill="none"
        stroke="currentColor"
...
// Collection/Archive Icon
export const CollectionIcon = ({ className = "w-3 h-3" }: IconProps) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
    </svg>
);

// Error Circle Icon (filled)
...
// Close X Icon (filled)
export const CloseFilledIcon = ({ className = "w-5 h-5", onClick }: IconProps) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 20 20"
