 ...
 *
 * All SVG icon components used throughout the application.
...
export function InboxStackIcon({ className }: IconProps) {
    return (
        <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
interface BotIndicatorIconProps extends IconProps {
    animated?: boolean;
}

/** Accent ring used while the assistant is thinking / streaming. */
export function BotIndicatorIcon({ className, animated = false }: BotIndicatorIconProps) {
    return (
        <span
            aria-hidden
            className={`inline-block rounded-full border-2 border-[var(--color-border)] border-t-[var(--color-accent)] ${animated ? 'animate-spin' : ''} ${className ?? ''}`}
        />
    );
}
...
export function MindmapIcon({ className }: IconProps) {
    return (
        <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18m9-9H3m6.364-6.364L15.536 9.464m-7.072 0L12 12m3.536 3.536L12 12m-3.536 3.536L12 12" />
            <circle cx="12" cy="12" r="2" strokeWidth="2" fill="currentColor" />
            <circle cx="6" cy="6" r="1.5" strokeWidth="1.5" fill="currentColor" />
            <circle cx="18" cy="6" r="1.5" strokeWidth="1.5" fill="currentColor" />
            <circle cx="6" cy="18" r="1.5" strokeWidth="1.5" fill="currentColor" />
            <circle cx="18" cy="18" r="1.5" strokeWidth="1.5" fill="currentColor" />
        </svg>
    );
}
...
export function TagIcon({ className }: IconProps) {
    return (
        <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" d="m6 6 3 3" />
        </svg>
    );
}
