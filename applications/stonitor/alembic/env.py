"""Alembic migration environment for Stonitor."""
...
import applications.stonitor.market.models.orm  # noqa: F401
...
if _configured_url in (None, "driver://user:pass@localhost/dbname"):
